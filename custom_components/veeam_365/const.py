...
API_FEATURE_REQUIREMENTS = {
    # Button features
    "job_start_button": "api.job",
    "job_stop_button": "api.job",
    "job_retry_button": "api.job",
    "job_enable_button": "api.job",
    "job_disable_button": "api.job",
